  ...
  return (
    <div className="p-8 bg-pink-100">
      <div className="text-center mb-12">
        <h2 className="text-7xl font-bold mb-4">Our Services</h2>
      ...
      <div className="flex flex-col lg:flex-row items-center lg:ml-32">
        <div className="lg:w-1/2 p-4 sm:text-center md:text-center lg:text-center">
          <h3 className="text-7xl font-bold mb-4 text-left">Modular Exhibition</h3>
          <p className="text-gray-700 mb-4 text-3xl text-left">
          ...
          <button className="bg-red-500 text-white flex text-center px-4 pt-4  rounded h-20 w-44 font-bold text-2xl mt-4">
            Know More
          </button>
        </div>
        <div className="lg:w-1/2 p-4 relative">
          ...
          />
          <div className="absolute top-14 -left-7 bg-white p-2 rounded shadow-lg hidden lg:block">
            <img
              src="https://t4.ftcdn.net/jpg/02/14/74/61/360_F_214746128_31JkeaP6rU0NzzzdFC4khGkmqc8noe6h.jpg"
              alt="Mark Anderson"
          ...
          <div className="absolute -mt-96 -left-14 bg-red-500 p-2 h-16 w-16 rounded-xl shadow-lg -rotate-45 hidden lg:block">
            <LuUserCheck className="bg-red-500  h-10 w-10 text-white" />
          </div>
          <div className="absolute bottom-4 right-14 bg-white p-2 rounded-lg shadow-lg  items-center h-20 mr-72 hidden lg:flex">
      ...
      <div className="flex flex-col lg:flex-row-reverse items-center lg:ml-32 mt-12">
        <div className="lg:w-1/2 p-4">
          <h3 className="text-7xl font-bold mb-4">Best spoke Exhibition</h3>
        ...
        <div className="lg:w-1/2 p-4 relative">
          <img
            ...
            style={{ height: "900px", width: "800px" }}
          />
          <div className="absolute top-14 -left-7 bg-white p-2 rounded-xl shadow-lg hidden lg:block">
            <img
              src="https://t4.ftcdn.net/jpg/02/14/74/61/360_F_214746128_31JkeaP6rU0NzzzdFC4khGkmqc8noe6h.jpg"
              alt="Jane Doe"
              className="rounded-full mr-2 inline-block h-14 w-14"
          ...
          <div className="absolute -mt-96 -left-14 bg-red-500 p-2 h-12 w-12 rounded-xl shadow-lg -rotate-45 hidden lg:block">
            <LuUserCheck className="bg-red-500  h-7 w-7 text-white" />
          </div>
          <div className="absolute bottom-4 left-60  bg-white p-2 rounded-lg shadow-lg flex items-center h-20 ml-80 hidden lg:flex">
            <span className="material-icons text-red-500 font-bold">
              <CiCircleCheck />
            </span>
            <p className="ml-2 text-xl">We think about every detail</p>
